...
const renderer = ({ days, hours, minutes, seconds, completed }) => {
  if (completed) {
    ...
    return <span style={{ margin: "0", }}>NOW! PRIZES WILL BE CREDITED SHORTLY..</span>;
  } else {
    // Render a countdown
        ...
        <Container maxWidth="lg">
          <Box className={classes.profile}>
            <Box display="flex">
              <h1>
                {!loading && activeRace && (
                  <span style={{ margin: "0", }}>🏁 RACE ENDS: <Countdown
              ...
              <Fragment>
                            ...
                            <TableCell>
                              <Box display="flex" alignItems="center">
                                ...
                                <Box ml="1rem">
                                  ...
                                  <span className={classes.userlevel}>{entry.user_level}</span> {entry._user.username}
                                </Box>
                              </Box>
                            </TableCell>
                            <TableCell>
                ...
                <Box>
                  ...
                  <Button
                    ...
                    href="/race/last">VIEW LAST RACE</Button>
                  {/* </Link> */}
                </Box>
              </Fragment>
            ) : (
